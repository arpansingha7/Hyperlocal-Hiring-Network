      ...
      <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:flex items-center gap-2 bg-slate-100 dark:bg-slate-800 p-1 rounded-lg">
            <button onClick={() => changeLanguage('en')} className={`px-2 py-1 text-xs font-bold rounded ${i18n.language === 'en' ? 'bg-white dark:bg-slate-700 shadow shadow-sm text-primary' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}>EN</button>
            <button onClick={() => changeLanguage('hi')} className={`px-2 py-1 text-xs font-bold rounded ${i18n.language === 'hi' ? 'bg-white dark:bg-slate-700 shadow shadow-sm text-primary' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}>HI</button>
            <button onClick={() => changeLanguage('gu')} className={`px-2 py-1 text-xs font-bold rounded ${i18n.language === 'gu' ? 'bg-white dark:bg-slate-700 shadow shadow-sm text-primary' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}>GU</button>
          </div>

          <button onClick={toggleTheme} className="text-slate-500 dark:text-slate-300 hover:text-primary transition-colors flex items-center justify-center p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800">
